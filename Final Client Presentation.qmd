...
- **Selected products:** Raw Honey, Seasonal Produce Box, Local Gift Basket, Strawberry Jam, Farm Fresh Eggs
- **Product titles:** Each name includes the brand, product, and size (e.g., "CPP Farm Store Raw Honey, 16 oz") so customers instantly know what they're looking at
- **Descriptions:** Every listing explains what it is, why it's local, how to use it, and whether pickup is available
- **Prices:** Set for each product, ranging from everyday items like eggs and jam to the higher-priced Gift Basket
- **Availability:** Labeled clearly as In Stock, Seasonal, or Out of Stock
- **Images:** One coordinated photo shoot — natural lighting, consistent background, photos that show exactly what's included
- **Pickup information:** Each listing states whether the item is available for in-store pickup, shipping, or both

### Recommended Products for Promotion

- **Raw Honey** — low cost, strong local story, best for attracting new customers
- **Seasonal Produce Box** — keeps customers coming back throughout the year
- **Local Gift Basket** — highest value, best for graduation, holidays, and other gifting occasions

### Retail Media Opportunity

- **Google Merchant Center:** Gets products listed and approved for Google's shopping platforms
- **Google Shopping:** Puts products in front of customers already searching for local or campus gifts
- **Improved online product discovery:** Makes it easier for new customers to find CPP Farm Store online
