...
author: "Kevin Bachez, Alexa Bueno, Sandy, Brian, Ron Sabilla"
date: today
...
format:
  revealjs:
    ...
    controls: true
    progress: true
    footer: "CPP Farm Store • Omnichannel Strategy"
---
...
# Shopify / Ecommerce Recommendation
...
## Prototype Evidence: Homepage {.visual-slide}

![Figure 4.1: Homepage mockup](images/homepage-mockup.png){width=75%}

## Prototype Evidence: Product & Basket Flow {.visual-slide}

![Figure 4.2: Product page mockup](images/product-page-mockup.png){width=45%}

![Figure 4.3: Build Your Own basket flow](images/byo-basket.png){width=45%}
...
## Campaign Objective {.focus-slide}
...
## Campaign Message {.message-slide}

**Thoughtful Gifts, Grown Here**

## Target Audience {.card-slide}
...
## Creative Objective {.focus-slide}
...
## Creative Assets {.creative-slide}

![](images/banner.png){.creative-banner}

::: {.creative-bottom}
![](images/basket.png){.creative-basket}

![](images/insta-poll.png){.creative-phone}
:::

## Channel Fit {.focus-slide}
...
## Analytics Dashboard {.focus-slide}
...
## Measurement Objectives {.card-slide}
...
## Key Performance Indicators {.kpi-slide}
...
## Dashboard Visualizations {.card-slide}
...
## What Should Be Measured? {.card-slide}
...
## Measurement Opportunity {.focus-slide}
...
## Recommended Customer Journey {.journey-slide}
...
- [Final Report](PASTE-REPORT-GITHUB-PAGES-LINK-HERE)

- [GitHub Repository](<https://github.com/brianvuong1/retail-group-projects.git>)

## Thank You

### CPP Farm Store Omnichannel Strategy

**Final Client Presentation**

Kevin Bachez, Alexa Bueno, Sandy, Brian, Ron Sabilla
