...
- **Prices:** Not currently listed on the website — this is a gap to fix before any retail-media push
...
- **Improved online product discovery:** Right now customers must call the store to order — moving to visible pricing and online ordering is the biggest opportunity to capture gift-buyers already searching online

# 6. Campaign Strategy

### Business Problem

- CPP Farm Store already offers online gift box ordering, but most customers don't know it exists — so they buy gifts elsewhere instead
